        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-8 text-center relative">
            ...
            <p className="text-blue-100">
              Create a free account to send your invoice
            </p>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <Button
              ...
              className="w-full h-12 gap-3 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800"
            >
              {isGoogleLoading ? (
