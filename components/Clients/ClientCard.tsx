...
export default function ClientCard({ client }: { client: any }) {
  ...
  return (
    <>
      ...
      {/* Edit Modal - Moved outside the card to avoid overflow:hidden issues */}
      {showEditModal && (
        <div
        ...
        >
          <div
            className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
