            ...
            <div className="py-6 px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-rose-200 dark:bg-rose-900/30 rounded-xl animate-pulse" />
                  <div>
                ...
                <div className="h-10 w-32 bg-rose-200 dark:bg-rose-900/30 rounded-lg animate-pulse" />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-8">
                {[...Array(4)].map((_, i) => (
                  ...
                  >
                    ...
                    <div className="h-8 w-20 bg-slate-300 dark:bg-slate-600 rounded animate-pulse" />
                  </div>
                ))}
              </div>

              {/* Category breakdown skeleton */}
              <div className="bg-white/60 dark:bg-slate-900/60 rounded-xl p-6 border border-slate-200/50 dark:border-slate-800/50 mb-8">
              ...
              <div className="bg-white/60 dark:bg-slate-900/60 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 overflow-hidden">
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 border-b border-slate-200/50 dark:border-slate-800/50"
                  >
